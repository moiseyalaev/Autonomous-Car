...
class Dqn():
    def __init__(self, input_size, nb_action, gamma): # Error when we try to create the brain for the game!
        self.gamma = gamma
        self.reward_window = []
        self.model = Network(input_size, nb_action)
        self.memory = ReplayMemory(100000)              # Compleation error for some reasn!!
